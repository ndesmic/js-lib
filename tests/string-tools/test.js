...
QUnit.module(".parseLiteralList");
QUnit.test("gets number values", function(assert){
	var result = StringTools.parseLiteralList("1,2,3");
	assert.deepEqual(result, [1,2,3], "got number list");
});
QUnit.test("gets float values", function(assert){
	var result = StringTools.parseLiteralList("1.0,2.1,3.05,1e10");
	assert.deepEqual(result, [1.0,2.1,3.05,1e10], "got float list");
});
QUnit.test("gets string values", function(assert){
	var result = StringTools.parseLiteralList('"one","two","three"');
	assert.deepEqual(result, ["one","two","three"], "got string list");
});
QUnit.test("gets string values with commas", function(assert){
	var result = StringTools.parseLiteralList('"one","two","three,four"');
	assert.deepEqual(result, ["one","two","three,four"], "got string list");
});
QUnit.test("gets bool values", function(assert){
	var result = StringTools.parseLiteralList('true, false, true, true');
	assert.deepEqual(result, [true,false,true,true], "got string list");
});
QUnit.test("gets null values", function(assert){
	var result = StringTools.parseLiteralList('null,1');
	assert.deepEqual(result, [null,1], "got string list");
});
QUnit.test("gets undefined values", function(assert){
	var result = StringTools.parseLiteralList('undefined,"one"');
	assert.deepEqual(result, [undefined,"one"], "got string list");
});
QUnit.test("gets mixed values", function(assert){
